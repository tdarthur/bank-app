		...
		<>
			<div className={styles.legalContent}>
				...
				<p className={styles.p}>
					...
					this long block of text for really no apparent reason other than the fact that I am bored. If you
					were looking for an actual <span className="text-soft">Privacy Policy</span> or{" "}
